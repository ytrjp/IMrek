    ...
    implements Runnable
{
  ...
  //Now accepts user and pass strings
    ...
    public void process(MqttPublish mqttpublish)
    {
        ...
        {
            MQeTrace.trace(this, (short)-30021, 0x200000L, mqttpublish.getQos() != 1 ? "PUBREC" : "PUBACK", new Integer(mqttpublish.getMsgId()));
        ...
        throws MqttException, MqttNotConnectedException
    {
        ...
        if(mqttpacket.getQos() > 0)
        {
            ...
            boolean flag = getKeepAlivePeriod() <= 0 ? outstandingQueue.size() > 0 : outstandingQueue.size() > 1;
            if(flag)
                l = 0L;
