...
public class MqttConnect extends MqttPacket
{
    ...
    public byte[] toBytes()
    {
        ...
        message = new byte[100]; //Create a new array of 42 bytes
        ...
        if(Will)
        {
            ...
            byte[] m1 = MqttUtils.concatArray(message, 0, i, abyte1, 0, abyte1.length);
            i += abyte1.length;
            message = MqttUtils.concatArray(m1, 0, i, abyte2, 0, abyte2.length);
            i += abyte2.length;
        }
        ...
        if(Username.length() > 1 && Password.length() > 1) {
            ...
            byte[] m2 = MqttUtils.concatArray(message, 0, i, abyte3, 0, abyte3.length);
            i+= abyte3.length;
            message = MqttUtils.concatArray(m2, 0, i, abyte4, 0, abyte4.length);
            i+= abyte4.length;
        }
